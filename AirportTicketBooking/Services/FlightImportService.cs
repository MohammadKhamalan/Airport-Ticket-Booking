...
namespace AirportTicketBooking.Services
{
    public class FlightImportService : IFlightImportService
    {
        ...
        private string _flightPath = @"C:\Users\ASUS\Desktop\Airport Ticket Booking\AirportTicketBooking\Data\Flight.csv";

        public FlightImportService(IFlightsData flightsData)
        {
